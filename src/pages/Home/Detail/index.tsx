                    ...
                    <Layout style={{ padding: "0 24px 24px",paddingRight: '200px' ,backgroundColor: '#fff' }}>
                        ...
                        <Row justify="space-around">
                            <Col style={{ border: '1px solid #eceaea', textAlign: 'center' }} span={4}>
                                <img style={{ width: '200px' }} src="https://s3-alpha-sig.figma.com/img/fb9a/fecd/b8f5e823c9b842321b300fe1113268c3?Expires=1660521600&Signature=BzUJ9KmLAQ~UfLOUsj0E7eiS2lnpI-Zz72sL6z2RyQNl0wG9w-YpEpPXMeIYUzKh6yY0Rboce7gsX8KKdluUOHxApiKk-yCkHX6maX2ZUBcNcp9N6BmbXlKqIr4gaPZwWp0~t8~kt7VmIoVXnf8rlL3LzgUSFYCbl3g2Fvlzq~zD~8JSYiRR6dHZ4xr1DZi-ejNZSMZv-sK03wn~DFxPL0jNg4r-137DEORCCU0Tq7tp0B33EZQGVkbNt7LWr8s7-5jfov2Qb2IdIOgoKDbZCCx6dhWOSy611JtbzERQg46xE4XecebD0VSsgfw7gEkWgBUbeNMLeSIunss4ydcsJA__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA" alt="" />
